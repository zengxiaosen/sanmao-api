...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/channel_usage", middleware.AdminTokenAuthReadOnly(), controller.GetChannelUsageStats)
		logRoute.GET("/model_channel_usage", middleware.AdminTokenAuthReadOnly(), controller.GetModelChannelUsageStats)
		logRoute.GET("/channel_model_usage", middleware.AdminTokenAuthReadOnly(), controller.GetChannelModelUsageStats)
